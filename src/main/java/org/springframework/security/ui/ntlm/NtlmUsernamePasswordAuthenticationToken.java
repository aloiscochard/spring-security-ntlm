...
public class NtlmUsernamePasswordAuthenticationToken extends UsernamePasswordAuthenticationToken {
    ...
    /**
     * Dummy authority collection which is passed to the constructor of the parent class,
     * ensuring that the "authenticated" property is set to "true" by default. See SEC-609.
     */
    private static final Collection<GrantedAuthority> NTLM_AUTHENTICATED = AuthorityUtils.commaSeparatedStringToAuthorityList("NTLM_AUTHENTICATED");
